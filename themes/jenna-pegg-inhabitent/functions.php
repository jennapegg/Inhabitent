<?php
/**
 * jenna-pegg-inhabitent functions and definitions.
 *
...
function red_starter_scripts() {
	...
	wp_enqueue_script( 'jenna-pegg-inhabitent_custom_js', get_template_directory_uri() . '/build/js/custom.min.js', array('jquery'), '2018', true );
